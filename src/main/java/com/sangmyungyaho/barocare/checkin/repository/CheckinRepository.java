...
public interface CheckinRepository extends JpaRepository<Checkin, Long> {
	...
	// TODO: User 연동 후 findAllByUserIdAndCheckedDateLessThanEqualOrderByCheckedDateDesc(Long userId, LocalDate checkedDate)로 변경
	List<Checkin> findAllByCheckedDateLessThanEqualOrderByCheckedDateDesc(LocalDate checkedDate);
}
