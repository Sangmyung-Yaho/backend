...
public class ReportController {
	...
	public ResponseEntity<com.sangmyungyaho.barocare.global.response.ApiResponse<ReportDto.WarningsResponse>> getLatestCauseWarnings() {
		ReportDto.WarningsResponse response = reportService.getLatestCauseWarnings();
		return ResponseEntity.ok(com.sangmyungyaho.barocare.global.response.ApiResponse.success(
				"고위험 조합 경고를 조회했습니다.", response));
	}
}
